      ...
      <main className="mx-auto w-full max-w-[90%] 2xl:max-w-[1600px] px-5 py-12 md:px-8 lg:px-12">
        <div className="mb-10">
          ...
          <p className="text-base leading-relaxed text-[#4B5563] mt-3 md:text-lg">
            Mantené contacto directo con empresas y otros usuarios de Jobee.
          </p>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-[#4B5563] leading-relaxed">
                El sistema de mensajería está en desarrollo. Pronto podrás comunicarte directamente con empresas y otros usuarios de la plataforma.
              </p>
            </div>
          </div>
        </div>
