                  ...
                  <div className="flex gap-3 mt-3">
                    {formData.linkedin && (
                      <a
                        ...
                        className="p-2 rounded-xl bg-[#FFF8E7] border-b-4 border-[#0B7285] text-[#0B7285] transition-all duration-150 ease-out hover:opacity-90"
                      >
                    ...
                    {formData.cv && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="p-2 rounded-xl bg-[#FFF8E7] border-b-4 border-[#DC2626] text-[#DC2626] transition-all duration-150 ease-out hover:opacity-90"
                      >
            ...
            <section className="rounded-3xl bg-[#FFF8E7] p-6 md:p-8">
              ...
              {courses.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <a
                    href="/user/courses"
                    className="inline-block mt-4 px-6 py-2 rounded-xl bg-[#FFD65B] border-b-4 border-[#E69C00] text-[#1F2937] font-semibold transition-all duration-150 ease-out hover:opacity-90"
                  >
                    Explorar Cursos
                  </a>
                </div>
