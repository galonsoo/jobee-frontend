      ...
      <nav className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex gap-6">
            <Link to="/company/dashboard" className="text-gray-900 font-semibold border-b-2 border-gray-900">
              Dashboard
            </Link>
      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Welcome back, {user?.email || 'Company'}
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-gray-600">Courses Published</p>
                <p className="text-3xl font-bold text-gray-900 mt-2">-</p>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <span className="font-medium text-gray-700">Find Candidates</span>
            </Link>
